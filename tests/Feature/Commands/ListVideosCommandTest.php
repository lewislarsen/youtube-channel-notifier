...
it('displays a list of videos', function () {
...
it('displays an empty table when no videos exist', function () {
    $this->artisan(ListVideosCommand::class)
        ->expectsTable([
            'Title', 'Creator', 'Published', 'URL',
        ], []);
...
it('orders videos by most recently published', function () {
    $channel = Channel::factory()->create();
...
it('displays correct video information', function () {
    $channel = Channel::factory()->create();
